...
public:
    ...
    void appendModelPackage(const QString &packageName, ModelPackage *package);//增
    QList<QSharedPointer<ModelPackage *>> selectModelPackage(const QString &pid);//查
...
private:
    ...
    static QMultiHash<QString, QSharedPointer<ModelPackage *>> s_modelPackageHash;
